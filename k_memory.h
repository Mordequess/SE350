...
#define HEAP_START_ADDR (0x10002000 - sizeof(heap_blk *)) //arbitrarily chosen to leave enough space on either side
#define HEAP_END_ADDR 0x10005200 //(HEAP_START_ADDR + BLOCK_SIZE * 100 + sizeof(heap_blk *))
